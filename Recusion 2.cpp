...
const int nx = 2e5+5;
int tt [nx];
int prrev2(int ar[],int n,int i)
{
    if(i<=n/2)
    {
        cout << ar[i]<< sp << ar[n-1-i]<<endl; /// zokhon backtracking hobe tokn abar print hobe
        prrev2(ar,n,i+1);/// Print korar agei abar function call hoye gelo
