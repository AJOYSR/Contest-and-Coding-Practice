...
{
    fast ;
    double nirnayok,a,b,c,pos,neg,div,temp;

    while(cin>>a>>b>>c)
    {
        nirnayok = (double)sqrt(b*b-(4*a*c));
        div   = (double)2.0*a;
        pos = (double)(-b+nirnayok)/div;
        neg = (double)(-b-nirnayok)/div;
        if(pos<neg)
        {
            temp = pos;
            pos = neg;
        ...
        cout<<fixed;
        cout<<setprecision(15)<<pos<<endl;
        cout<<setprecision(15)<<neg<<endl;
